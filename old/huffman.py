...
class HuffmanObject(object):
    ...
    def __binary_tree_to_lookup_table(self, branch, binary_path = ''):
        ...
        if '0' in branch:
            self.__binary_tree_to_lookup_table(branch['0'], binary_path +
                    '0')
            self.__binary_tree_to_lookup_table(branch['1'], binary_path +
                    '1')
            return
    ...
    def encode(self, data_string):
        ...
        for char in data_string:
            binary_string += self.huffman_table[char]
    ...
    def decode(self, data_string):
        ...
        binary_string = ''
        for char in data_string:
            binary_string += '{0:08b}'.format(char)[::-1]
        ...
        for bit in binary_string:
            if bit in tree_node:
                ...
                decoded_string += chr(tree_node['asc'])
